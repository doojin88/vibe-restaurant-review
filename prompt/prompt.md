...
6. common-task-planner 에이전트를 이용하여 /docs/common-modules.md 경로에 공통 모듈 작업 계획을 작성하라.
7. state-planner 에이전트를 이용하여 상태관리설계문서를 작성한다.
8. plan-writer 에이전트를 이용하여 구현계획을 작성한다.
